...
calories: 'Ca. 120 kcal pr. portion uden smør'
category: 'Snack'
...
conclusion: |
  Til film-aften er **gryde med låg** eller **dedikeret popcornmaskine** ofte mere forudsigelige end airfryer.

  Vil du have noget luftigt i airfryer, er [ristede nødder med honning](/opskrifter/airfryer-ristede-noedder-honning-rosmarin) ofte et bedre match.
ingredients:
  - text: '40–60 g popcornkerner (små batch)'
  - text: '1 tsk neutral olie eller smeltet smør'
  - text: 'Salt efter smag'
instructions:
  - text: 'Tjek bruksanvisning for din airfryer: må popcorn overhovedet? Hvis nej — stop her.'
  - text: 'Bland kerner og olie i en lille skål så alt er let dækket.'
  - text: 'Forvarm til 200 °C hvis manualen anbefaler høj varme til kerner — ellers følg fabrikantens max.'
  - text: 'Hæld i **rist-/perforeret indsats** eller et lille ildfast fad med kun ét lag kerner. Undgå løse kerner direkte i lukket skuffe, der kan hoppe ind i varmelegeme (brandfare).'
  - text: 'Kør 8–12 minutter og **lyt** efter pop — stop når popningen ebber ud (som i mikro/gryde). Brandt duft: sluk med det samme.'
  - text: 'Hæld straks over i skål. Salt.'
tips:
...
Brandfare ved løse kerner og høj varme. **Børn** under opsyn. Sluk apparatet ved røg eller brændt lugt.
