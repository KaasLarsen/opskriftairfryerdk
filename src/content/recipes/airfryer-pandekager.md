...
temperatureC: 175
keywords:
  - pandekager i airfryer
  - pandekage i airfryer
...
intro: |
  ...
  Denne opskrift bruger kærnemælk eller yoghurt for luftighed. Vil du lave **bananpandekager**, moser du én moden banan ind i væsken og reducerer sukker en smule.

  Brug spray eller smør i formene, så løsner kagerne let.
conclusion: |
  Top med sirup, bær, skyr eller peanutbutter. Rester opvarmes kort i mikro eller 1–2 minutter i airfryer ved lav varme.

  Se også [toast med grillet ost](/opskrifter/airfryer-toast-grillet-ost) til hurtig brunch.
ingredients:
  - text: '200 g hvedemel'
  ...
  - text: '½ tsk salt'
  - text: '1 æg'
  - text: '250 ml kærnemælk eller syrnet mælk'
  - text: '30 g smeltet smør + lidt til forme'
  - text: 'Valgfrit: 1 moden banan + ½ tsk kanel (bananpandekager)'
instructions:
  - text: 'Pisk æg, mælk og smeltet smør sammen. Mos banan i, hvis du laver bananvariant.'
...
faq:
  ...
  - question: 'Bananpandekager i airfryer – justering?'
    answer: 'Mos banan i væsken og brug evt. 1 spsk mindre sukker; bag lidt længere hvis dejen er tungere.'
  - question: 'Kan jeg fryse dem?'
    answer: 'Ja — optø og varm igennem; teksturen bliver bedre med kort opvarmning i airfryer end mikro alene.'
---

### Variation

Tilsæt **blåbær** i dejen eller **chokoladeknapper** til børn – fyld formene lidt mindre, så de hæver.
