...
1. **Lav CTR, høj eksponering** (hurtigste gevinst): `airfryer-flaeskesteg`, `airfryer-forloren-hare`, `airfryer-popcorn`, `airfryer-leverpostej`, `airfryer-torsk` — skærp **title/description**, 1 tydeligt svar i intro, **FAQ** der matcher søgeord, og et **friskt hero** hvis billedet ikke matcher konkurrenterne. *(2026-05-22: title/description + FAQ/meta justeret på disse samt udvidet ribeye/entrecôte-afsnit på `airfryer-okseboef-steak`.)* **Samme dato, batch 2:** `airfryer-havregroed`, `airfryer-pandekager`, `airfryer-blomkaal`, `airfryer-chokoladekage-lille-form`, `airfryer-lammekoelle-skiver`, `airfryer-hel-kylling` — titel/description, keywords og FAQ til snippets (GSC top‑liste). **2026-05-23, batch 3:** `airfryer-nachos-kylling-jalapenos` — nachos/air fryer-ordformer + FAQ; `airfryer-aeg` — røræg først i titel/description + snippet-FAQ; `airfryer-kyllingelever` + `airfryer-kalvelever` — “stegt lever … tid” og kryds‑FAQ mellem ky/kalv. **2026-05-24, bred batch (~30 stk):** 20 opskrifter (bl.a. oksebøf-cluster, pulled chicken, tofu, gyoza/dumplings, bacon/broccoli/mozzarella/hytteost, fisk/snacks) + `guides/index` + 10 skærpede guide‑meta + `modified` synk på alle guide‑undersider. **2026-05-21, batch 5 (~30 opskrifter):** Meta/FAQ/keywords + `updatedDate` på ej tidligere maj 22–24‑polerede slugs — bl.a. `airfryer-pomfritter`, `airfryer-falafler`, `airfryer-groentsagsmix`, `airfryer-kartofler-i-baade`, `airfryer-frosne-franske-kartofler`, `airfryer-hakkeboef`, `airfryer-ribbensteg`, `airfryer-jalapeno-poppers`, `airfryer-bbq-kyllingelaar`, `airfryer-kyllingelaar`, `airfryer-kyllingespyd`, `airfryer-kyllingelaarfilet`, `airfryer-kyllingelaar-uden-ben`, `airfryer-paaskeskinke`, `airfryer-squash`, `airfryer-bagekartofler`, `airfryer-soede-kartofler`, `airfryer-corn-dogs`, `airfryer-loaded-fries-jalapenos-ost`, `airfryer-quesadillas-kylling-ost`, `airfryer-frosne-foraarsruller`, `airfryer-loegringe`, `airfryer-stegte-sild`, `airfryer-moerbrad`, `airfryer-selleri`, `airfryer-asparges`, `airfryer-kyllingenuggets`, `airfryer-honning-guleroedder`, `airfryer-karamel-ananas`, `airfryer-aeggekage-asparges-bacon`. **2026-05-26, batch 6 (~30 opskrifter):** Meta/FAQ/keywords + `updatedDate` på bl.a. `airfryer-poelsemix-kartofler`, `airfryer-champignon`, `airfryer-varm-kartoffelsalat`, `airfryer-halloumi-honning-citron`, `airfryer-frossen-laks`, `airfryer-naan-pitabroed`, `airfryer-toast-grillet-ost`, `airfryer-oksespidsbryst`, `airfryer-hummer`, `airfryer-poelsehorn-frost`, `airfryer-aebleskiver`, `airfryer-majskolber`, `airfryer-cevapi`, `airfryer-pljeskavica`, `airfryer-raznjici`, `airfryer-kikaerter-roestet`, `airfryer-rejer-sriracha-hvidloegslime`, `airfryer-andefrikadeller`, `airfryer-pastinak-fritter-lime-yoghurt`, `airfryer-kylling-sennepfloede`, `airfryer-churros`, `airfryer-roedkaal`, `airfryer-kammuslinger-bacon`, `airfryer-kylling-ajvar`, `airfryer-fiskepinde`, `airfryer-kalveculotte`, `airfryer-hvidloegsbroed-ost-bites`, `airfryer-vildsvin-kotelet`, `airfryer-oksehjerte`, `airfryer-bagt-hvidloeg-parmesan`.
2. **Okse/cluster**: `airfryer-okseboef-steak` dækker ribeye/entrecote — ensartet blok “Ribeye vs. entrecote” + samme struktur i FAQ.
3. **Nye opskrifter kun når det mangler** — se `src/data/gsc-missing-recipe-urls.json` (fx brunede kartofler, bagte pærer, kyllingefilet): vurder om de skal laves som egne sider **med** `heroImage`/`heroAlt` og PNG i `public/images/recipes/`. **2026-05-21:** Arbejdsgang for løbende nye sider ud fra alle forespørgsler → [`docs/gsc-ny-indhold-arbejdsgang.md`](gsc-ny-indhold-arbejdsgang.md) og `npm run gsc:ny-indhold-kandidater` efter eksport til `src/data/gsc-forespoergsler.csv`. Eksempler på første nye tekstsider samme dato: `airfryer-toast-aeug-i-hul`, `airfryer-spaghetti-med-koedsovs` med opdaterede legacy‑mapper.
   - **2026-05-21, GSC-batch (primært nye tekst-sider):** Dedikerede slugs ud fra huller/kandidater: `airfryer-roastbeef`, `airfryer-lammeculotte`, `airfryer-omelet`, `airfryer-saltmandler`, `airfryer-rodfrugter`, `airfryer-oksemoerbrad`, `airfryer-spareribs`, `airfryer-torskeloins`, `airfryer-aebelflaesk`, `airfryer-droemmekage-lille-form`, `airfryer-fastelavnsboller` (hero-billeder kan tilføjes senere efter backlog-praksis).
   - *Øvrigt 2026-05-21:* Dedikerede sider findes allerede på bl.a. `airfryer-brunede-kartofler`, `airfryer-bagte-paerer-honning-noedder`, `airfryer-kyllingebryst`; overrides i `recipe-legacy-redirect-overrides.json` peger `.html`/venlige slugs korrekt. `/kapacitet/8liter` → liter-guide.
...
5. Når du vil **rette ind imod huller**, se **[`docs/gsc-ny-indhold-arbejdsgang.md`](gsc-ny-indhold-arbejdsgang.md)** og kør `npm run gsc:ny-indhold-kandidater`.
6. Efter publicering: notér dato ved slug; efter 4–8 uger tjek samme forespørgsel for **CTR** og **placering** i GSC.
